...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // GUI controls
  const panel = document.getElementById('particleSettingsPanel');
  if (panel) {
    // Set initial values from restored settings
    document.getElementById('particleBgColor').value = BG_COLOR;
    document.getElementById('particleDotColor').value = DOT_COLOR;
    document.getElementById('particleDotSize').value = DOT_SIZE;
    document.getElementById('particleQuantity').value = PARTICLE_COUNT;
    document.getElementById('particleScatter').value = PARALLAX;
    document.getElementById('particlePosX').value = Math.round(POS_X * 100);
    document.getElementById('particlePosY').value = Math.round(POS_Y * 100);
    document.getElementById('particleSpeed').value = PARTICLE_SPEED;
    document.getElementById('particleEntropy').value = PARTICLE_ENTROPY;
    document.getElementById('particleLinearRatio').value = Math.round(PARTICLE_LINEAR_RATIO * 100);
    document.getElementById('particleLinearRatioValue').textContent = Math.round(PARTICLE_LINEAR_RATIO * 100) + '%';

    document.getElementById('particleBgColor').addEventListener('input', function(e) {
      BG_COLOR = e.target.value;
      saveSettings();
    });
    document.getElementById('particleDotColor').addEventListener('input', function(e) {
      DOT_COLOR = e.target.value;
      saveSettings();
    });
    document.getElementById('particleDotSize').addEventListener('input', function(e) {
      DOT_SIZE = parseInt(e.target.value);
      regenerateParticles();
      saveSettings();
    });
    document.getElementById('particleQuantity').addEventListener('input', function(e) {
      PARTICLE_COUNT = parseInt(e.target.value);
      regenerateParticles();
      saveSettings();
    });
    document.getElementById('particleScatter').addEventListener('input', function(e) {
      PARALLAX = parseInt(e.target.value);
      saveSettings();
    });
    document.getElementById('particlePosX').addEventListener('input', function(e) {
      POS_X = parseInt(e.target.value) / 100;
      saveSettings();
    });
    document.getElementById('particlePosY').addEventListener('input', function(e) {
      POS_Y = parseInt(e.target.value) / 100;
      saveSettings();
    });
    document.getElementById('particleSpeed').addEventListener('input', function(e) {
      PARTICLE_SPEED = parseFloat(e.target.value);
      regenerateParticles();
      saveSettings();
    });
    document.getElementById('particleEntropy').addEventListener('input', function(e) {
      PARTICLE_ENTROPY = parseFloat(e.target.value);
      regenerateParticles();
      saveSettings();
    });
    document.getElementById('particleLinearRatio').addEventListener('input', function(e) {
      PARTICLE_LINEAR_RATIO = parseInt(e.target.value) / 100;
      document.getElementById('particleLinearRatioValue').textContent = e.target.value + '%';
      regenerateParticles();
      saveSettings();
    });
    document.getElementById('particleSettingsExport').addEventListener('click', function() {
      const settings = {
        PARTICLE_COUNT,
        DOT_COLOR,
        DOT_SIZE,
    ...
    document.getElementById('particleSettingsClose').addEventListener('click', function() {
